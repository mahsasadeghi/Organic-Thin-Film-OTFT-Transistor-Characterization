...
mobility = pd.read_excel('mobility.xlsx')

#-----------------------------------------------------
#edgecolor='black'--> board color of the bar  
# linewidth=1.2 --> size of the linewidth around the bar 
mobility.hist( bins='auto', color='darkred',alpha = 1, rwidth=1,edgecolor='black', linewidth=1)
#-----------------------------------------------------
#Title Font 
plt.title('Mobility', fontsize = 20)
#label of y-axis 
...
plt.grid(b=None)
plt.savefig('mobility2.png', transparent = True, bbox_inches = 'tight')
plt.savefig('mobility2.eps', transparent = True, bbox_inches = 'tight')
plt.show()
